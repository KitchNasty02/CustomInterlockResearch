...
def main():
    ...
    mesh_left, mesh_right = add_3d_dovetail_interlock(mesh_left, mesh_right, 0, 0, beam_width_layers=4, beam_depth_layers=8, beam_height_layers=4, avoidance_layers=2, z_inverted=True, y_inverted=True)
